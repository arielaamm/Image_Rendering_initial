...
public class VectorTest {
    Vector v1 = new Vector(-7,-9,4);
    Vector v2 = new Vector(0,2,0);
    Vector v3 = new Vector(-7,8,4);
    Vector v1SameDirec = new Vector(1, -2, 3);
    Vector v2SameDirec = new Vector(1, -2, -2);
    Vector v1DifDirec = new Vector(2,1,5);
    Vector v2DifDirec = new Vector(-2,-1,-5);
    Vector v1DifDirecSize = new Vector(2,1,6);
    Vector v2DifDirecSize = new Vector(-2,-1,-7);
    Vector v1Vertical = new Vector(0,0,6);
    Vector v2Vertical = new Vector(0,3,0);

    
    @Test
    void testAdd() {

    Vector v1_add_v2SameDirec = new Vector(2,-4,1);
    Vector v1_add_v2DifDirecSize = new Vector(0,0,-1);
    Vector v1_add_v2Vertical = new Vector(0, 3, 6);
    Vector v1_add_v2 = new Vector(-7, -7, 4);
    Vector v1_add_v3= new Vector(-14,-1,8);
